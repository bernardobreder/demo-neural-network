 ...
 *
 * HistogramElement: An element in the histogram. This is the word, and the
 * number of times it came up in either the good or bad set.
 *
 * @author Jeff Heaton
 * @version 2.1
 */
public class HistogramElement implements Comparable<HistogramElement>, Serializable {
	/**
	...
	public int compareTo(final HistogramElement o) {
		final int result = o.getCount() - this.getCount();
		if (result == 0) {
