...
public class XOR {
	...
	public static void main(final String args[]) {
		...
		for (int i = 0; i < XOR_IDEAL.length; i++) {
			...
			System.out.println(XOR_INPUT[i][0] + "," + XOR_INPUT[i][1] + ", actual="
					+ new BigDecimal(actual[0]).toString() + ",ideal=" + XOR_IDEAL[i][0]);
		}
		System.out.println(Arrays.toString(network.computeOutputs(new double[] { 1, 0 })));
	}
}
