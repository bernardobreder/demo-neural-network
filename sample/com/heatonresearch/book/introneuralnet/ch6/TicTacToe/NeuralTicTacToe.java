...
public class NeuralTicTacToe {
	...
	public static FeedforwardNetwork createNetwork() {
		...
		// FeedforwardLayer(NeuralTicTacToe.NEURONS_HIDDEN_2));
	...
	public static FeedforwardNetwork loadNetwork() throws IOException {
		try {
			return (FeedforwardNetwork) SerializeObject.load("tictactoe.net");
	...
	public void geneticNeural() throws IOException {
		...
		TicTacToeGenetic train = new TicTacToeGenetic(network, true, NeuralTicTacToe.POPULATION_SIZE,
				NeuralTicTacToe.MUTATION_PERCENT, NeuralTicTacToe.MATE_PERCENT, this.player2.getClass());
		...
		do {
			train.iteration();
			System.out.println("Epoch #" + epoch + " Error:" + train.getScore() + ",minutes left="
