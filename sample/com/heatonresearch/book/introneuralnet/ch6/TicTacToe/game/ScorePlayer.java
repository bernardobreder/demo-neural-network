...
public class ScorePlayer {
	...
	public final static double PERFECT_SCORE = NeuralTicTacToe.SCORE_SAMPLE * WIN_POINTS;
	Player player;
	Player aganst;
	boolean verbose;

	public ScorePlayer(final Player player, final Player aganst, final boolean verbose) {
		this.player = player;
		this.aganst = aganst;
