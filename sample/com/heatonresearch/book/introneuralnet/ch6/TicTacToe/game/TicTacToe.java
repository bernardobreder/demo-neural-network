...
/**
 * Mother class for the <code>net.bluebones.tictactoe</code> package. This class
 * is executable and expects as two commandline arguments the names of the
...
public class TicTacToe {
	...
	public static byte reverse(final byte i) {
		...
		if (i == TicTacToe.NOUGHTS) {
			...
			throw new IllegalArgumentException("Number supplied was " + i + " but must be TicTacToe.NOUGHTS ("
					+ TicTacToe.NOUGHTS + ") or TicTacToe.CROSSES (" + TicTacToe.CROSSES + ")");
		}
	}
