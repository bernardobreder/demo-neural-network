...
class Node {
	 ...
	 * @param move
	 *            <code>Move</code> last move that was taken to reach this board
	 *            position.
	 */
	...
	/**
	 * Gets the "next" child for this node, or <code>null</code> if all children
	 * of this node have already been found.
	 *
	 ...
	 *
	 * @return <code>boolean</code>, <code>true</code> if the node is a leaf.
	 */
	public boolean isLeaf() {
		if (this._leaf == null) {
			return (Board.isFull(this._board) || Board.isWinner(this._board, TicTacToe.NOUGHTS)
					|| Board.isWinner(this._board, TicTacToe.CROSSES));
		}
	 ...
	 */
	public byte player() {
		return (this._move == null ? TicTacToe.NOUGHTS : TicTacToe.reverse(this._move.color()));
	}
	 ...
	 *            <code>TicTacToe.CROSSES</code>.
	 * @return <code>int</code> abstract value only meaningful in comparison to
	 *         other node values. Higher is better for the specified player.
	 */
