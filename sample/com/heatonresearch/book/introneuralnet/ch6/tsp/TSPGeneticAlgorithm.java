...
public class TSPGeneticAlgorithm extends GeneticAlgorithm<TSPChromosome> {
	...
	public TSPGeneticAlgorithm(final City cities[], final int populationSize, final double mutationPercent,
			final double percentToMate, final double matingPopulationPercent, final int cutLength)
		...
		this.setChromosomes(new TSPChromosome[this.getPopulationSize()]);
