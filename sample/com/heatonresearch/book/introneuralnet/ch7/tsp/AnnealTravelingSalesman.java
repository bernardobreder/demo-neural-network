 ...
 *
 * AnnealTravelingSalesman: Try to solve the traveling salesman problem using
 * simulated annealing.
 *
 * @author Jeff Heaton
 * @version 2.1
 */
public class AnnealTravelingSalesman extends JFrame implements Runnable, ComponentListener {
