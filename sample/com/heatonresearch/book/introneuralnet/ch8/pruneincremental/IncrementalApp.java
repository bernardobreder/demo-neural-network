 ...
 */
package com.heatonresearch.book.introneuralnet.ch8.pruneincremental;
...
public class IncrementalApp extends JFrame implements ActionListener, Runnable {
	...
	public IncrementalApp() {
		this.setTitle("XOR Solution - Incremental Prune");
	...
	public void run() {
		...
		while (!prune.getDone()) {
			...
			update++;
			if (update == 10) {
				this.status.setText("Cycles:" + prune.getCycles() + ",Hidden Neurons:" + prune.getHiddenNeuronCount()
