...
/**
 * NeuralGeneticAlgorithm: Implements a genetic algorithm that allows a
 * feedforward neural network to be trained using a genetic algorithm. This
 * algorithm is for a feed forward neural network.
 *
 * This class is abstract. If you wish to train the neural network using
 * training sets, you should use the TrainingSetNeuralGeneticAlgorithm class. If
 * you wish to use a cost function to train the neural network, then implement a
...
public class NeuralGeneticAlgorithm<GA_TYPE extends GeneticAlgorithm<?>>
	...
	public FeedforwardNetwork getNetwork() {
		final NeuralChromosome<GA_TYPE> c = this.getChromosome(0);
		c.updateNetwork();
		return c.getNetwork();
	}
