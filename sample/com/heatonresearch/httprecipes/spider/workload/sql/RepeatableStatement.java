...
public class RepeatableStatement {
	...
	public class Results {
		...
		public void close() {
			...
			RepeatableStatement.this.releaseStatement(this.statement);
		}
	 ...
	 */
	private List<PreparedStatement> statementCache = new ArrayList<>();
	 ...
	 *             Thrown if the SQL cannot be executed, and retrying the
	...
	public void execute(Object... parameters) throws WorkloadException {
		...
		try {
			statement = this.obtainStatement();
	...
	public Results executeQuery(Object... parameters) throws WorkloadException {
		...
		for (;;) {
			try {
				PreparedStatement statement = this.obtainStatement();
