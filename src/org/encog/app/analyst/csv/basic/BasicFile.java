...
public class BasicFile implements QuantTask {
	 ...
	 *            The format to use.
	 */
	public static void appendSeparator(final StringBuilder line, final CSVFormat format) {
	...
	public void performBasicCounts() {
		...
		this.resetStatus();
		int rc = 0;
		final ReadCSV csv = new ReadCSV(this.inputFilename.toString(), this.expectInputHeaders, this.format);
	 ...
	 *
	 * @param theExpectInputHeaders
	 *            Are input headers expected?
	 */
	public void setExpectInputHeaders(final boolean theExpectInputHeaders) {
	 ...
	 */
	public void setProduceOutputHeaders(final boolean theProduceOutputHeaders) {
