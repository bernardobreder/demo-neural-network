...
public class AnalystNormalizeCSV extends BasicFile {
	 ...
	 *            The analyst to use.
	 * @param headers
	 *            The headers for the input data.
	 * @param csv
	 *            The CSV that holds the input data.
	 * @param outputLength
	 *            The length of the returned array.
	 * @param skipOutput
	 *            True if the output should be skipped.
	 * @return The encoded data.
	 */
	public static final double[] extractFields(final EncogAnalyst analyst, final CSVHeaders headers, final ReadCSV csv,
	 ...
	 *            True, if input headers are present.
	 * @param inputFormat
	 *            The format.
	 * @param theAnalyst
	 *            The analyst to use.
	 */
	public void analyze(final File inputFilename, final boolean expectInputHeaders, final CSVFormat inputFormat,
	...
	public void normalize(final File file) {
		...
		try {
			...
			while (csv.next() && !this.shouldStop()) {
				...
				double[] output = AnalystNormalizeCSV.extractFields(this.analyst, this.analystHeaders, csv,
						outputLength, false);
	 ...
	 */
	public void setSourceFile(final File file, final boolean headers, final CSVFormat format) {
