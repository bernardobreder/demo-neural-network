...
public class AnalystReport {
	...
	public String produceReport() {
		...
		final String t = this.analyst.getScript().getProperties().getPropertyString(ScriptProperties.ML_CONFIG_TYPE);
		final String a = this.analyst.getScript().getProperties()
				.getPropertyString(ScriptProperties.ML_CONFIG_ARCHITECTURE);
		final String rf = this.analyst.getScript().getProperties()
	...
	public void produceReport(final File filename) {
		try {
			final String str = this.produceReport();
