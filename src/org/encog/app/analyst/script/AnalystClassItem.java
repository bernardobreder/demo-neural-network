...
public class AnalystClassItem implements Comparable<AnalystClassItem> {
	 ...
	 *
	 * @param theCode
	 *            The code, this is how it is in the CSV.
	 * @param theName
	 *            The name, a more meaningful name than code. Can be the same as
	 *            code, if desired.
	 * @param theCount
	 *            The count.
	 */
	public AnalystClassItem(final String theCode, final String theName, final int theCount) {
		super();
		this.code = theCode;
		this.name = theName;
		this.count = theCount;
