...
public class PropertyEntry implements Comparable<PropertyEntry> {
	 ...
	 */
	public static String dotForm(final String section, final String subSection, final String name) {
	 ...
	 *            The section of the property.
	 */
	public PropertyEntry(final PropertyType theEntryType, final String theName, final String theSection) {
		super();
	 ...
	 */
	public void validate(final String theSection, final String subSection, final String theName, final String value) {
