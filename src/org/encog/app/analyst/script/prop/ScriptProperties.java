...
public class ScriptProperties {
	...
	public final CSVFormat getPropertyCSVFormat(final String name) {
		...
		final AnalystFileFormat code = ConvertStringConst.string2AnalystFileFormat(value);
	 ...
	 *
	 * @param revertedData
	 *            The source data to revert from.
	 */
	 ...
	 */
	public final void setProperty(final String name, final AnalystFileFormat format) {
		if (format == null) {
			this.data.put(name, "");
		} else {
	...
	public final void setProperty(final String name, final double d) {
		this.data.put(name, CSVFormat.EG_FORMAT.format(d, Encog.DEFAULT_PRECISION));
	}
