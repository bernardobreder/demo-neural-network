...
public class EncogProgramNode extends EncogTreeNode {
	 ...
	 */
	private final List<EncogProgramArg> args = new ArrayList<>();
	 ...
	 */
	public EncogProgramNode(final EncogGenProgram theProgram, final EncogTreeNode theParent, final NodeType theNodeType,
	...
	public EncogProgramNode createArray(final String name, final double[] a) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.InitArray, name);
		node.addArg(a);
	...
	public EncogProgramNode createFunction(final String theName) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.StaticFunction, theName);
		this.getChildren().add(node);
		return node;
	}
	 ...
	 */
	public EncogProgramNode createFunctionCall(final EncogProgramNode funct, final String returnType,
			final String returnVariable) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.FunctionCall,
				funct.getName());
	 ...
	 * @return The newly created function call.
	 */
	public EncogProgramNode createFunctionCall(final String name, final String returnType,
			final String returnVariable) {

		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.FunctionCall, name);
		node.addArg(returnType);
		node.addArg(returnVariable);
		this.getChildren().add(node);
		return node;
	...
	public EncogProgramNode createMainFunction() {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.MainFunction, null);
		this.getChildren().add(node);
		return node;
	}
	 ...
	 */
	public EncogProgramNode createNetworkFunction(final String name, final File method) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.CreateNetwork, name);
		node.addArg(method);
		this.getChildren().add(node);
		return node;
	}
	 ...
	 */
	public void defineConst(final EncogArgType type, final String name, final String value) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.Const, name);
		node.addArg(value);
	...
	public EncogProgramNode embedTraining(final File data) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.EmbedTraining, "");
		node.addArg(data);
		this.getChildren().add(node);
		return node;
	}
	...
	public EncogProgramNode generateLoadTraining(final File data) {
		final EncogProgramNode node = new EncogProgramNode(this.getProgram(), this, NodeType.LoadTraining, "");
		node.addArg(data);
		this.getChildren().add(node);
		return node;
	}
