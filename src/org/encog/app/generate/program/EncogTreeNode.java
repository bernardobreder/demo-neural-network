...
public class EncogTreeNode {
	 ...
	 *            The parent.
	 */
	public EncogTreeNode(final EncogGenProgram theProgram, final EncogTreeNode theParent) {
	...
	public void addComment(final String str) {
		final EncogProgramNode node = new EncogProgramNode(this.program, this, NodeType.Comment, str);
