...
public abstract class Indicator extends BaseCachedColumn {
	 ...
	 */
	public Indicator(final String name, final boolean input, final boolean output) {
	 ...
	 */
	public final void require(final Map<String, BaseCachedColumn> theData, final String item) {
