...
/**
 * Computationally efficient alternative to ActivationSigmoid. Its output is in
 * the range [0, 1], and it is derivable.
 *
 * It will approach the 0 and 1 more slowly than Sigmoid so it might be more
