...
public interface ActivationFunction extends Serializable, Cloneable {
	 ...
	 *
	 * @param b
	 *            The number to calculate the derivative of, the number "before"
	...
	/**
	 * @return The string for the Encog factory code. Return null if you do not
	 *         care to be support for creating of your activation through
	 *         factory.
	 */
