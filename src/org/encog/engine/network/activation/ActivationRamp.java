...
public class ActivationRamp implements ActivationFunction {
	 ...
	 */
	public ActivationRamp(final double thresholdHigh, final double thresholdLow, final double high, final double low) {
	...
	public final void activationFunction(final double[] x, final int start, final int size) {
		final double slope = (this.params[ActivationRamp.PARAM_RAMP_HIGH_THRESHOLD]
	...
	public final ActivationFunction clone() {
		return new ActivationRamp(this.params[ActivationRamp.PARAM_RAMP_HIGH_THRESHOLD],
				this.params[ActivationRamp.PARAM_RAMP_LOW_THRESHOLD], this.params[ActivationRamp.PARAM_RAMP_HIGH],
	...
	public final String[] getParamNames() {
		final String[] result = { "thresholdHigh", "thresholdLow", "high", "low" };
		return result;
	}
