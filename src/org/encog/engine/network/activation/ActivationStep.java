...
public class ActivationStep implements ActivationFunction {
	 ...
	 */
	public ActivationStep(final double low, final double center, final double high) {
	...
	public final ActivationFunction clone() {
		final ActivationStep result = new ActivationStep(this.getLow(), this.getCenter(), this.getHigh());
		return result;
	}
