...
/**
 * Provides a foundation for most random number generation. This allows the
 * nextDouble to generate the other types.
 */
public abstract class AbstractGenerateRandom implements GenerateRandom {
	...
	public int nextInt(final int low, final int high) {
		return (low + (int) (this.nextDouble() * ((high - low))));
	}
