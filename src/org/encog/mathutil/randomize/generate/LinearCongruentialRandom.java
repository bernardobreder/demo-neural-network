...
/**
 * A Linear Congruential random number generator. A Linear Congruential
 * Generator (LCG) yields a sequence of randomized numbers calculated with a
 * linear equation. The method represents one of the oldest and best-known
 * pseudorandom number generator algorithms. Most programming languages use this
 * technique.
 *
 * http://en.wikipedia.org/wiki/Linear_congruential_generator/ Donald Knuth, The
 * Art of Computer Programming, Volume 3, Section 3.2.1
 */
public class LinearCongruentialRandom extends AbstractBoxMuller {
	...
	public LinearCongruentialRandom(final long theSeed) {
		this((long) Math.pow(DEFAULT_MOD1, DEFAULT_MOD2), DEFAULT_MULT, DEFAULT_INC, theSeed);
	}
	 ...
	 *            DotNet.
	 */
	public LinearCongruentialRandom(final long theModulus, final long theMultiplier, final long theIncrement,
			final long theSeed) {
		super();
	...
	public final double nextDouble() {
		return (double) this.nextLong() / LinearCongruentialRandom.MAX_RAND;
	}
