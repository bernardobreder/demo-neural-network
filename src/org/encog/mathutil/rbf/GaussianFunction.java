...
public class GaussianFunction extends BasicRBF {
	 ...
	 */
	public GaussianFunction(final double center, final double peak, final double width) {
	 ...
	 *            The widths for each dimension.
	 */
	public GaussianFunction(final double peak, final double[] center, final double width) {
