...
public class InverseMultiquadricFunction extends BasicRBF {
	 ...
	 */
	public InverseMultiquadricFunction(final double center, final double peak, final double width) {
	 ...
	 *            The widths for each dimension.
	 */
	public InverseMultiquadricFunction(final double peak, final double[] center, final double width) {
	...
	public final double calculate(final double[] x) {
		double value = 0;
		final double[] center = this.getCenters();
