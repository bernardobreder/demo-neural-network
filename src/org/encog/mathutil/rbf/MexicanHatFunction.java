...
public class MexicanHatFunction extends BasicRBF {
	 ...
	 */
	public MexicanHatFunction(final double center, final double peak, final double width) {
	 ...
	 *            The widths for each dimension.
	 */
	public MexicanHatFunction(final double peak, final double[] center, final double width) {
