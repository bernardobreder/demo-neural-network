...
public class MultiquadricFunction extends BasicRBF {
	 ...
	 */
	public MultiquadricFunction(final double center, final double peak, final double width) {
	 ...
	 *            The widths for each dimension.
	 */
	public MultiquadricFunction(final double peak, final double[] center, final double width) {
