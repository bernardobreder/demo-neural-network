 ...
 * classification is attempting to use the input to place items into classes. It
 * is assumed that an item will only be in one single class. If an item can be
