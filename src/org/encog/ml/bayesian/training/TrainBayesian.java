...
public class TrainBayesian extends BasicTraining {
	...
	public TrainBayesian(BayesianNetwork theNetwork, MLDataSet theData, int theMaximumParents) {
		this(theNetwork, theData, theMaximumParents, BayesianInit.InitNaiveBayes, new SearchK2(),
				new SimpleEstimator());
	}
	 ...
	 * @param theInit
	 *            How to init the new Bayes network.
	 * @param theSearch
	 *            The search method.
	 * @param theEstimator
	 *            The estimation mehod.
	 */
	public TrainBayesian(BayesianNetwork theNetwork, MLDataSet theData, int theMaximumParents, BayesianInit theInit,
			BayesSearch theSearch, BayesEstimator theEstimator) {
