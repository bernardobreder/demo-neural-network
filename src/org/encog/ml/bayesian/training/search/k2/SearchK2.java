...
public class SearchK2 implements BayesSearch {
	 ...
	 *
	 * @param event
	 *            The event that we are clauclating for.
	 * @param n
	 *            The value for n.
	 * @param old
	 *            The old value.
	...
	private BayesianEvent findZ(BayesianEvent event, int n, double old) {
		...
		for (int i = 0; i < n; i++) {
			...
			List<BayesianEvent> parents = new ArrayList<>();
	 ...
	 * @param event
	 *            The event we are calculating for. (variable i)
	 * @param parents
	 *            The parents of the specified event we are considering.
	 * @param parentInstance
	 *            The parent instance we are looking for.
	 * @param desiredValue
	 *            The desired value.
	 * @return The value N.
	 */
	public int calculateN(BayesianNetwork network, BayesianEvent event, List<BayesianEvent> parents,
			int[] parentInstance, int desiredValue) {
		int result = 0;
