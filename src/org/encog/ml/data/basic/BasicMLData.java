...
public class BasicMLData implements MLData, Serializable, Cloneable {
	...
	public MLData times(double d) {
		MLData result = new BasicMLData(this.size());
	...
	/**
	 * Apply a thresholding function to the data elements. This does not modify
	 * the object.
	 *
	 * @param thresholdValue
	 *            the value to which elements are compared
	 * @param lowValue
	 *            the value to use if &le; threshold
	 * @param highValue
	 *            the value to use if &ge; threshold
	 * @return The result.
	 */
