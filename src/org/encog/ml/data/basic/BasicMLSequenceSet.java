...
public class BasicMLSequenceSet implements Serializable, MLSequenceSet {
	...
	public class BasicMLSeqIterator implements Iterator<MLDataPair> {
		...
		public boolean hasNext() {
			...
			MLDataSet seq = BasicMLSequenceSet.this.sequences.get(this.currentSequenceIndex);
		...
		public MLDataPair next() {
			...
			MLDataSet target = BasicMLSequenceSet.this.sequences.get(this.currentSequenceIndex);
