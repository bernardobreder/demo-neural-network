...
public class TemporalDataDescription {
	 ...
	 *            Used for prediction?
	 */
	public TemporalDataDescription(final ActivationFunction activationFunction, final double low, final double high,
	 ...
	 *            Used for prediction?
	 */
	public TemporalDataDescription(final ActivationFunction activationFunction, final Type type, final boolean input,
	 ...
	 *            Used for prediction?
	 */
	public TemporalDataDescription(final Type type, final boolean input, final boolean predict) {
