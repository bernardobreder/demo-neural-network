...
public class PerformDataDivision {
	 ...
	 *            The ideal count.
	 */
	public void perform(List<DataDivision> dataDivisionList, VersatileMLDataSet dataset, int inputCount,
			int idealCount) {
	 ...
	 *            The ideal count.
	 */
	private void createDividedDatasets(List<DataDivision> dataDivisionList, VersatileMLDataSet parentDataset,
			int inputCount, int idealCount) {
		for (DataDivision division : dataDivisionList) {
			MatrixMLDataSet dataset = new MatrixMLDataSet(parentDataset.getData(), inputCount, idealCount,
					division.getMask());
	...
	/**
	 * Generate the counts for all divisions, give remaining items to final
	 * division.
	 *
	 * @param dataDivisionList
	 *            The division list.
