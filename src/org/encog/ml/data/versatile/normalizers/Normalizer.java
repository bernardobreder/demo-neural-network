...
public interface Normalizer extends Serializable {
	...
	/**
	 * Normalize a column from a string. The output will go to an array,
	 * starting at outputColumn.
	 *
	 * @param colDef
	 ...
	 */
	int normalizeColumn(ColumnDefinition colDef, String value, double[] outputData, int outputIndex);

	/**
	 * Normalize a column from a double. The output will go to an array,
	 * starting at outputColumn.
	 *
	 * @param colDef
	 *            The column that is being normalized.
	 ...
	 */
	String denormalizeColumn(ColumnDefinition colDef, MLData data, int dataIndex);
}
