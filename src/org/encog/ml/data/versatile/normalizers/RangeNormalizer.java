...
public class RangeNormalizer implements Normalizer {
	...
	public String denormalizeColumn(ColumnDefinition colDef, MLData data, int dataColumn) {
		...
		final double result = ((colDef.getLow() - colDef.getHigh()) * value - this.normalizedHigh * colDef.getLow()
				+ colDef.getHigh() * this.normalizedLow) / (this.normalizedLow - this.normalizedHigh);
