...
public class RangeOrdinal implements Normalizer {
	 ...
	 */
	@Override
	public int normalizeColumn(ColumnDefinition colDef, String theValue, double[] outputData, int outputColumn) {
		...
		double result = (value / high) * (this.normalizedHigh - this.normalizedLow) + this.normalizedLow;
	...
	public String denormalizeColumn(ColumnDefinition colDef, MLData data, int dataColumn) {
		...
		final double result = ((low - high) * value - this.normalizedHigh * low + high * this.normalizedLow)
