...
public interface NormalizationStrategy extends Serializable {
	 ...
	 */
	int normalizeColumn(ColumnDefinition colDef, boolean isInput, String value, double[] outpuData, int outputColumn);
	 ...
	 * @return The new output element, advanced by the correct amount.
	 */
	String denormalizeColumn(ColumnDefinition colDef, boolean isInput, MLData output, int idx);
	 ...
	 * @return The new output element, advanced by the correct amount.
	 */
	int normalizeColumn(ColumnDefinition colDef, boolean isInput, double value, double[] outpuData, int outputColumn);
