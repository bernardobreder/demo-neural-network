...
public class ComplexityAdjustedScore implements AdjustScore {
	 ...
	 *
	 * @param theComplexityPenaltyThreshold
	 *            The complexity level at which a penalty begins to be applied.
	 * @param theComplexityPentaltyFullThreshold
	 *            The complexity level at which a full (100%) penalty is
	 *            applied.
	 * @param theComplexityPenalty
	 *            The starting complexity penalty.
	 * @param theComplexityFullPenalty
	 *            The full complexity penalty.
	 */
	public ComplexityAdjustedScore(int theComplexityPenaltyThreshold, int theComplexityPentaltyFullThreshold,
	...
	public double calculateAdjustment(Genome genome) {
		...
		if (genome.size() > this.complexityPenaltyThreshold) {
			...
			double complexityPenalty = ((this.complexityFullPenalty - this.complexityPenalty) / range) * over;
	...
	/**
	 * @param complexityPenalty
	 *            the complexityPenalty to set
	 */
	...
	/**
	 * @param complexityFullPenalty
	 *            the complexityFullPenalty to set
	 */
	...
	/**
	 * @param complexityPenaltyThreshold
	 *            the complexityPenaltyThreshold to set
	 */
