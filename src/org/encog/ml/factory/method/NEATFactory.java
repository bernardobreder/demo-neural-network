...
public class NEATFactory {
	...
	public MLMethod create(final String architecture, final int input, final int output) {
		...
		final int cycles = holder.getInt(MLMethodFactory.PROPERTY_CYCLES, false, NEATPopulation.DEFAULT_CYCLES);

		ActivationFunction af = this.factory
				.create(holder.getString(MLMethodFactory.PROPERTY_AF, false, MLActivationFactory.AF_SSIGMOID));
