...
public class PNNTrainFactory {
	 ...
	 */
	public MLTrain create(final MLMethod method, final MLDataSet training, final String args) {

		if (!(method instanceof BasicPNN)) {
			throw new EncogError("PNN training cannot be used on a method of type: " + method.getClass().getName());
		}
