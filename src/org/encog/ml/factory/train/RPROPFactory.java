...
public class RPROPFactory {
	...
	public MLTrain create(final MLMethod method, final MLDataSet training, final String argsStr) {
		...
		final double initialUpdate = holder.getDouble(MLTrainFactory.PROPERTY_INITIAL_UPDATE, false,
				RPROPConst.DEFAULT_INITIAL_UPDATE);
		final double maxStep = holder.getDouble(MLTrainFactory.PROPERTY_MAX_STEP, false, RPROPConst.DEFAULT_MAX_STEP);
