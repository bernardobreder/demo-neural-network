...
public class SVMSearchFactory {
	...
	public MLTrain create(final MLMethod method, final MLDataSet training, final String argsStr) {
		...
		final double gammaStart = holder.getDouble(SVMSearchFactory.PROPERTY_GAMMA1, false,
		...
		final double gammaStop = holder.getDouble(SVMSearchFactory.PROPERTY_GAMMA2, false,
		...
		final double gammaStep = holder.getDouble(SVMSearchFactory.PROPERTY_GAMMA_STEP, false,
				SVMSearchTrain.DEFAULT_GAMMA_STEP);
		final double cStep = holder.getDouble(SVMSearchFactory.PROPERTY_C_STEP, false,
				SVMSearchTrain.DEFAULT_CONST_STEP);
