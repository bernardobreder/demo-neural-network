...
public class MLMethodGeneticAlgorithm extends BasicTraining implements MultiThreadable {
	...
	public class MLMethodGeneticAlgorithmHelper extends TrainEA {
		 ...
		 *            The score function.
		 */
		public MLMethodGeneticAlgorithmHelper(final Population thePopulation, final CalculateScore theScoreFunction) {
	 ...
	 *            The population size.
	 */
	public MLMethodGeneticAlgorithm(final MethodFactory phenotypeFactory, final CalculateScore calculateScore,
