...
public class MLMethodGenomeFactory implements GenomeFactory {
	 ...
	 *            The population.
	 */
	public MLMethodGenomeFactory(final MethodFactory theFactory, final Population thePopulation) {
	...
	public Genome factor() {
		final Genome result = new MLMethodGenome((MLEncodable) this.factory.factor());
	...
	public Genome factor(final Genome other) {
		final MLMethodGenome result = (MLMethodGenome) this.factor();
		result.copy(other);
		result.setPopulation(this.population);
		return result;
	}
