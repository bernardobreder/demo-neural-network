 ...
 * Markov models (HMM).
 *
 * Viterbi AJ (April 1967). "Error bounds for convolutional codes and an
...
public class ViterbiCalculator {
	...
	private void computeStep(final HiddenMarkovModel hmm, final MLDataPair o, final int t, final int j) {
