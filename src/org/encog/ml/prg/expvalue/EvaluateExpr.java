...
public final class EvaluateExpr {
	 ...
	 */
	public static ExpressionValue add(final ExpressionValue a, final ExpressionValue b) {
	 ...
	 */
	public static ExpressionValue div(final ExpressionValue a, final ExpressionValue b) {
		if (a.isInt() && b.isInt()) {
	 ...
	 * @return True/false.
	 */
	public static ExpressionValue equ(final ExpressionValue a, final ExpressionValue b) {
	 ...
	 * @return The result of the operation.
	 */
	public static ExpressionValue mul(final ExpressionValue a, final ExpressionValue b) {
		if (a.isInt() && b.isInt()) {
			return new ExpressionValue(a.toIntValue() * b.toIntValue());
		}
		return new ExpressionValue(a.toFloatValue() * b.toFloatValue());
	 ...
	 * @return True/false.
	 */
	public static ExpressionValue notequ(final ExpressionValue a, final ExpressionValue b) {
		if (a.getExpressionType() == ValueType.booleanType) {
			return new ExpressionValue(a.toBooleanValue() != b.toBooleanValue());
		} else if (a.getExpressionType() == ValueType.enumType) {
			return new ExpressionValue(a.toIntValue() != b.toIntValue() && a.getEnumType() == b.getEnumType());
	 ...
	 * @return The result of the operation.
	 */
	public static ExpressionValue pow(final ExpressionValue a, final ExpressionValue b) {
		if (a.isInt() && b.isInt()) {
	 ...
	 * @return The result of the operation.
	 */
	public static ExpressionValue protectedDiv(final ExpressionValue a, final ExpressionValue b) {
		if (a.isInt() && b.isInt()) {
			final long i = b.toIntValue();
			if (i == 0) {
	 ...
	 * @return The result of the operation.
	 */
	public static ExpressionValue sub(final ExpressionValue a, final ExpressionValue b) {
		if (a.isInt() && b.isInt()) {
			return new ExpressionValue(a.toIntValue() - b.toIntValue());
		} else {
			return new ExpressionValue(a.toFloatValue() - b.toFloatValue());
