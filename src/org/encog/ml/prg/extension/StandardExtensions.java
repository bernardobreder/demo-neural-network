...
public class StandardExtensions {
	 ...
	 * Variable support.
	 */
	public static ProgramExtensionTemplate EXTENSION_VAR_SUPPORT = new BasicTemplate(ProgramExtensionTemplate.NO_PREC,
			"#var():{*}", NodeType.Leaf, true, 1) {
		/**
		 * The serial id.
		 */
		...
		public ExpressionValue evaluate(final ProgramNode actual) {
			...
			final ExpressionValue result = actual.getOwner().getVariables().getVariable(idx);
			if (result == null) {
				throw new EARuntimeError(
						"Variable has no value: " + actual.getOwner().getVariables().getVariableName(idx));
			}
			return result;
		}
		 ...
		 */
		@Override
		public boolean isPossibleReturnType(final EncogProgramContext context, final ValueType rtn) {
		...
		public void randomize(final Random rnd, final List<ValueType> desiredTypes, final ProgramNode actual,
			...
			final int variableIndex = actual.getOwner().selectRandomVariable(rnd, desiredTypes);
			if (variableIndex == -1) {
	 ...
	 * Numeric const.
	 */
	public static ProgramExtensionTemplate EXTENSION_CONST_SUPPORT = new BasicTemplate(ProgramExtensionTemplate.NO_PREC,
			"#const():{*}", NodeType.Leaf, false, 1) {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
		 ...
		 */
		@Override
		public void randomize(final Random rnd, final List<ValueType> desiredType, final ProgramNode actual,
				final double minValue, final double maxValue) {
			final ValueType pickedType = desiredType.get(rnd.nextInt(desiredType.size()));
			final EncogProgramContext context = actual.getOwner().getContext();
			switch (pickedType) {
			case floatingType:
				actual.getData()[0] = new ExpressionValue(RangeRandomizer.randomize(rnd, minValue, maxValue));
				break;
			case stringType:
			...
			case booleanType:
				...
				break;
			case intType:
				actual.getData()[0] = new ExpressionValue((int) RangeRandomizer.randomize(rnd, minValue, maxValue));
				break;
			case enumType:
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_NEG = new BasicTemplate(3, "-({f,i}):{f,i}", NodeType.Unary, false,
			0) {
		/**
		 * The serial id.
		 */
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_ADD = new BasicTemplate(6, "+({f,i,s}{f,i,s}):{f,i,s}",
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.add(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_SUB = new BasicTemplate(6, "-({f,i}{f,i}):{f,i}",
			NodeType.OperatorLeft, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.sub(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_MUL = new BasicTemplate(5, "*({f,i}{f,i}):{f,i}",
			NodeType.OperatorLeft, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.mul(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_DIV = new BasicTemplate(5, "/({f,i}{f,i}):{f,i}",
			NodeType.OperatorLeft, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.div(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_PDIV = new BasicTemplate(5, "%({f,i}{f,i}):{f,i}",
			NodeType.OperatorLeft, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.protectedDiv(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_POWER = new BasicTemplate(1, "^({f,i}{f,i}):{f,i}",
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_AND = new BasicTemplate(10, "&({b}{b}):{b}", NodeType.OperatorLeft,
			false, 0) {
		/**
		 * The serial id.
		 */
	 ...
	 * Standard boolean binary and operator.
	 */
	public static ProgramExtensionTemplate EXTENSION_NOT = new BasicTemplate(3, "!({b}):{b}", NodeType.Unary, false,
			0) {
		/**
		 * The serial id.
		 */
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_OR = new BasicTemplate(12, "|({b}{b}):{b}", NodeType.OperatorLeft,
			false, 0) {
		/**
		 * The serial id.
		 */
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_EQUAL = new BasicTemplate(9, "=({*}{*}):{b}",
			NodeType.OperatorRight, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.equ(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_NOT_EQUAL = new BasicTemplate(9, "<>({*}{*}):{b}",
			NodeType.OperatorRight, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return EvaluateExpr.notequ(actual.getChildNode(0).evaluate(), actual.getChildNode(1).evaluate());
		}
	};
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_GT = new BasicTemplate(8, ">({i,f}{i,f}):{b}",
			NodeType.OperatorRight, false, 0) {
		/**
		 * The serial id.
		 */
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			return new ExpressionValue(actual.getChildNode(0).evaluate().toFloatValue() > actual.getChildNode(1)
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_LT = new BasicTemplate(8, "<({i,f}{i,f}):{b}",
			NodeType.OperatorRight, false, 0) {
		/**
		 * The serial id.
		 */
	 ...
	 * Standard boolean binary greater than operator.
	 */
	public static ProgramExtensionTemplate EXTENSION_GTE = new BasicTemplate(8, ">=({i,f}{i,f}):{b}",
			NodeType.OperatorRight, false, 0) {
		/**
		 * The serial id.
		 */
	 ...
	 * Standard boolean binary less than operator.
	 */
	public static ProgramExtensionTemplate EXTENSION_LTE = new BasicTemplate(8, "<=({i,f}{i,f}):{b}",
			NodeType.OperatorRight, false, 0) {
		/**
		 * The serial id.
		 */
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_ABS = new BasicTemplate("abs({f,i}):{f,i}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_ACOS = new BasicTemplate("acos({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_ASIN = new BasicTemplate("asin({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_ATAN = new BasicTemplate("atan({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_ATAN2 = new BasicTemplate("atan2({f}{f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_CEIL = new BasicTemplate("ceil({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_COS = new BasicTemplate("cos({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_COSH = new BasicTemplate("cosh({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_EXP = new BasicTemplate("exp({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_FLOOR = new BasicTemplate("floor({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_LOG = new BasicTemplate("log({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_LOG10 = new BasicTemplate("log10({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_MAX = new BasicTemplate("max({f,s,i}({f,s,i}):{f,s,i}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 * Standard numeric max function.
	 */
	public static ProgramExtensionTemplate EXTENSION_MIN = new BasicTemplate("min({f,s,i}({f,s,i}):{f,s,i}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_POWFN = new BasicTemplate("pow({f}{f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_RANDOM = new BasicTemplate("rand():{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 * Standard numeric log10 function.
	 */
	public static ProgramExtensionTemplate EXTENSION_ROUND = new BasicTemplate("round({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_SIN = new BasicTemplate("sin({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_SINH = new BasicTemplate("sinh({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_SQRT = new BasicTemplate("sqrt({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_TAN = new BasicTemplate("tan({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_TANH = new BasicTemplate("tanh({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_TODEG = new BasicTemplate("todeg({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_TORAD = new BasicTemplate("torad({f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_LENGTH = new BasicTemplate("length({s}):{i}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_FORMAT = new BasicTemplate("format({f}{i}):{s}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
		...
		public ExpressionValue evaluate(final ProgramNode actual) {
			return new ExpressionValue(
					actual.getOwner().getContext().getFormat().format(actual.getChildNode(0).evaluate().toFloatValue(),
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_LEFT = new BasicTemplate("left({s}{i}):{s}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			final String str = actual.getChildNode(0).evaluate().toStringValue();
			final int idx = (int) actual.getChildNode(1).evaluate().toFloatValue();
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_RIGHT = new BasicTemplate("right({s}{i}):{s}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_CINT = new BasicTemplate("cint({f}):{i}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_CFLOAT = new BasicTemplate("cfloat({i}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_CSTR = new BasicTemplate("cstr({*}):{s}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_CBOOL = new BasicTemplate("cbool({i,f}):{b}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_IFF = new BasicTemplate("iff({b}:{*}:{*}):{*}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			final boolean a = actual.getChildNode(0).evaluate().toBooleanValue();
			if (a) {
	 ...
	 */
	public static ProgramExtensionTemplate EXTENSION_CLAMP = new BasicTemplate("clamp({f}{f}{f}):{f}") {
		/**
		 * The serial id.
		 */
		private static final long serialVersionUID = 1L;
		...
		@Override
		public ExpressionValue evaluate(final ProgramNode actual) {
			final double value = actual.getChildNode(0).evaluate().toFloatValue();
	...
	public static void createAll(final EncogProgramContext context) {
		...
		for (final ProgramExtensionTemplate temp : EncogOpcodeRegistry.INSTANCE.findAllOpcodes()) {
	 ...
	 *            The context to add the opcodes to.
	 */
	public static void createConversionFunctions(final EncogProgramContext context) {
		final FunctionFactory factory = context.getFunctions();
	 ...
	 */
	public static void createNumericOperators(final EncogProgramContext context, final boolean protectedDiv) {
		final FunctionFactory factory = context.getFunctions();
