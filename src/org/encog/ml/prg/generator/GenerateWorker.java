...
public class GenerateWorker implements Runnable {
	 ...
	 */
	public GenerateWorker(final AbstractPrgGenerator theOwner, final PrgPopulation thePopulation) {
		this.owner = theOwner;
	...
	@Override
	public void run() {
		final EncogProgram prg = this.owner.attemptCreateGenome(this.rnd, this.population);
