...
public class PrgFullGenerator extends AbstractPrgGenerator {
	 ...
	 *            The max depth.
	 */
	public PrgFullGenerator(final EncogProgramContext theContext, final int theMaxDepth) {
	 ...
	 */
	@Override
	public ProgramNode createNode(final Random rnd, final EncogProgram program, final int depthRemaining,
			final List<ValueType> types) {
		return this.createRandomNode(rnd, program, depthRemaining, types, false, true);
	}
