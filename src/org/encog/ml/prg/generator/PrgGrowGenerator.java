...
public class PrgGrowGenerator extends AbstractPrgGenerator {
	 ...
	 *            The max depth.
	 */
	public PrgGrowGenerator(final EncogProgramContext theContext, final int theMaxDepth) {
	...
	public ProgramNode createNode(final Random rnd, final EncogProgram program, final int depthRemaining,
		...
		return this.createRandomNode(rnd, program, depthRemaining, types, true, true);
	}
