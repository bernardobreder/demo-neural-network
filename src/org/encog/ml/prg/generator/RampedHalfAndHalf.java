...
public class RampedHalfAndHalf extends AbstractPrgGenerator {
	 ...
	 *            The maximum depth.
	 */
	public RampedHalfAndHalf(final EncogProgramContext theContext, final int theMinDepth, final int theMaxDepth) {
	...
	public int determineMaxDepth(final Random rnd) {
		final int range = this.getMaxDepth() - this.minDepth;
