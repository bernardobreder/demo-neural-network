...
public class LevelHolder {
	/**
	 * Determine if the specified child types are compatible with the parent
	 * types.
	 *
	 * @param parentTypes
	 *            The parent types.
	 ...
	 */
	public static boolean compatibleTypes(final List<ValueType> parentTypes, final List<ValueType> childTypes) {
	...
	/**
	 * The current node, or node found. This will be the mutation or crossover
	 * point.
	 */
