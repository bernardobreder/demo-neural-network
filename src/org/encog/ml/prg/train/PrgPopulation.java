...
public class PrgPopulation extends BasicPopulation implements MLRegression {
	 ...
	 *            The population size.
	 */
	public PrgPopulation(final EncogProgramContext theContext, final int thePopulationSize) {
	...
	public MLData compute(final MLData input) {
		final EncogProgram best = (EncogProgram) this.getBestGenome();
	...
	public void dumpMembers(final int i) {
		...
		int index = 0;
		for (final Species species : this.getSpecies()) {
