 ...
 * improve by the specified amount over a number of cycles.
 *
 * @author jheaton
 *
 */
public class RequiredImprovementStrategy implements Strategy {
	 ...
	 *            The number of cycles to reach that rate.
	 */
	public RequiredImprovementStrategy(final double required, final double threshold, final int cycles) {
