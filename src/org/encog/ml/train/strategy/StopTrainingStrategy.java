...
public class StopTrainingStrategy implements EndTrainingStrategy {
	...
	public StopTrainingStrategy() {
		this(StopTrainingStrategy.DEFAULT_MIN_IMPROVEMENT, StopTrainingStrategy.DEFAULT_TOLERATE_CYCLES);
	}
	 ...
	 * @param toleratedCycles
	 *            The number of cycles to tolerate before stopping.
	 */
	public StopTrainingStrategy(final double minImprovement, final int toleratedCycles) {
