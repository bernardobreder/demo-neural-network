 ...
 *
 * techreport{Prechelt94c, author = {Lutz Prechelt}, title = {{PROBEN1} --- {A}
 * Set of Benchmarks and Benchmarking Rules for Neural Network Training
 * Algorithms}, institution = {Fakult\"at f\"ur Informatik, Universit\"at
 * Karlsruhe}, year = {1994}, number = {21/94}, address = {D-76128 Karlsruhe,
 * Germany}, month = sep, note = {Anonymous FTP:
 * /pub/pa\-pers/tech\-reports/1994/1994-21.ps.Z on ftp.ira.uka.de}, }
 */
public class EarlyStoppingStrategy implements EndTrainingStrategy {
	...
	/**
	 * eOpt value, calculated for early stopping. The lowest validation error so
	 * far.
	 */
	private double eOpt;
	...
	/**
	 * Alpha value, calculated for early stopping. Once "gl" is above alpha,
	 * training will stop.
	 */
	 ...
	 * @param theValidationSet
	 * @param theTestSet
	 * @param theStripLength
	 *            The number of training set elements to validate.
	 * @param theAlpha
	 *            Stop once GL is below this value.
	 * @param theMinEfficiency
	 *            The minimum training efficiency to stop.
	 */
	public EarlyStoppingStrategy(MLDataSet theValidationSet, MLDataSet theTestSet, int theStripLength, double theAlpha,
	...
	public void postIteration() {
		...
		if (this.lastCheck > this.stripLength) {
			...
			// System.out.println("eff=" + this.stripEfficiency + ", gl=" +
			// this.gl);
