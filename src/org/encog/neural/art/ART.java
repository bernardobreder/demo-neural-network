 ...
 * Stephen Grossberg and Gail Carpenter. There are several versions of the ART
 * neural network, which are numbered ART-1, ART-2 and ART-3. The ART neural
 * network is trained using either a supervised or unsupervised learning
 * algorithm, depending on the version of ART being used. ART neural networks
 * are used for pattern recognition and prediction.
 *
