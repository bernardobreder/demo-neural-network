...
public class CPN extends BasicML implements MLRegression, MLResettable, MLError {
	 ...
	 * @param theInstarCount
	 *            The number of instar neurons.
	 * @param theOutstarCount
	 *            The number of outstar neurons.
	 * @param theWinnerCount
	 *            The winner count.
	 */
	public CPN(final int theInputCount, final int theInstarCount, final int theOutstarCount, final int theWinnerCount) {
	...
	public MLData compute(final MLData input) {
		final MLData temp = this.computeInstar(input);
	...
	public void reset(final int seed) {
		final ConsistentRandomizer randomize = new ConsistentRandomizer(-1, 1, seed);
