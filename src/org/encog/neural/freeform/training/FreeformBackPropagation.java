...
public class FreeformBackPropagation extends FreeformPropagationTraining implements Serializable {
	 ...
	 * @param theTraining
	 *            The training data to use. The coefficient for how much of the
	 *            gradient is applied to each weight.
	 * @param theLearningRate
	 *            The learning rate. The coefficient for how much of the
	 *            previous delta is applied to each weight. In theory, prevents
	 *            local minima stall.
	 * @param theMomentum
	 *            The momentum.
	 */
	public FreeformBackPropagation(final FreeformNetwork theNetwork, final MLDataSet theTraining,
			final double theLearningRate, final double theMomentum) {
	...
	protected void learnConnection(final FreeformConnection connection) {
		...
		final double delta = (gradient * this.learningRate) + (connection.getTempTraining(1) * this.momentum);
