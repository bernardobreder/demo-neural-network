...
public class NEATPopulation extends BasicPopulation implements Serializable, MLError, MLRegression {
	...
	public void reset() {
		...
		for (int i = 0; i < this.getPopulationSize(); i++) {
			final NEATGenome genome = this.getGenomeFactory().factor(rnd, this, this.inputCount, this.outputCount,
	 ...
	 */
	public void setInitialConnectionDensity(final double initialConnectionDensity) {
	 ...
	 *
	 * @param theInnovations
	 *            The innovation list to use.
	 */
	...
	/**
	 * Set the survival rate, this is the percent of the population allowed to
	 * mate.
	 *
	 * @param theSurvivalRate
	 *            The survival rate.
	 */
