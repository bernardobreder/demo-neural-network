...
public class NEATMutateWeights extends NEATMutation {
	 ...
	 *
	 * @param theLinkSelection
	 *            The method used to choose the links for mutation.
	 * @param theWeightMutation
	 *            The method used to actually mutate the weights.
	 */
	public NEATMutateWeights(final SelectLinks theLinkSelection, final MutateLinkWeight theWeightMutation) {
	...
	public void performOperation(final Random rnd, final Genome[] parents, final int parentIndex,
		...
		final double weightRange = ((NEATPopulation) this.getOwner().getPopulation()).getWeightRange();
		final List<NEATLinkGene> list = this.linkSelection.selectLinks(rnd, target);
