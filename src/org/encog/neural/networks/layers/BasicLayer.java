...
public class BasicLayer extends FlatLayer implements Layer, Serializable {
	 ...
	 */
	public BasicLayer(final ActivationFunction activationFunction, final boolean hasBias, final int neuronCount,
			double dropoutRate) {
		super(activationFunction, neuronCount, hasBias ? 1.0 : 0.0, dropoutRate);
	}
