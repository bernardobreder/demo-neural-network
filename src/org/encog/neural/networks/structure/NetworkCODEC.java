...
public final class NetworkCODEC {
	 ...
	 */
	public static void arrayToNetwork(final double[] array, final MLMethod network) {
		if (network instanceof MLEncodable) {
			((MLEncodable) network).decodeFromArray(array);
			return;
		}
		throw new NeuralNetworkError(NetworkCODEC.ERROR + network.getClass().getName());
	}
	 ...
	 */
	public static boolean equals(final BasicNetwork network1, final BasicNetwork network2) {
	 ...
	 * @return True if the two networks are equal.
	 */
	public static boolean equals(final BasicNetwork network1, final BasicNetwork network2, final int precision) {
		final double[] array1 = NetworkCODEC.networkToArray(network1);
		final double[] array2 = NetworkCODEC.networkToArray(network2);
