...
public class NeuralSimulatedAnnealing extends BasicTraining {
	 ...
	 */
	public NeuralSimulatedAnnealing(final MLEncodable network, final CalculateScore calculateScore,
	...
	public double[] getArray() {
		return NetworkCODEC.networkToArray(NeuralSimulatedAnnealing.this.network);
	}
	...
	public void putArray(final double[] array) {
		NetworkCODEC.arrayToNetwork(array, NeuralSimulatedAnnealing.this.network);
	}
	...
	public void randomize() {
		final double[] array = NetworkCODEC.networkToArray(NeuralSimulatedAnnealing.this.network);
