...
public class BPROPJob extends TrainingJob {
	 ...
	 *            The momentum to use.
	 */
	public BPROPJob(final BasicNetwork network, final MLDataSet training, final boolean loadToMemory,
	...
	public void createTrainer(final boolean singleThreaded) {
		final Propagation train = new Backpropagation(this.getNetwork(), this.getTraining(), this.getLearningRate(),
				this.getMomentum());
