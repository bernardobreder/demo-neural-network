...
public class StochasticGradientDescent extends Propagation implements Momentum, LearningRate {
	 ...
	 */
	public StochasticGradientDescent(final ContainsFlat network, final MLDataSet training, final int batchSize,
			final double theLearnRate, final double theMomentum) {
		super(network, new StochasticDataSet(training, new MersenneTwisterGenerateRandom()));
		ValidateNetwork.validateMethodToData(network, training);
		this.dataset = (StochasticDataSet) this.getTraining();
