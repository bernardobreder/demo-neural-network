...
public class TrainAdaline extends BasicTraining implements LearningRate {
	 ...
	 *            The learning rate.
	 */
	public TrainAdaline(final BasicNetwork network, final MLDataSet training, final double learningRate) {
	...
	public void iteration() {
		...
		for (final MLDataPair pair : this.training) {
			...
			for (int currentAdaline = 0; currentAdaline < output.size(); currentAdaline++) {
				final double diff = pair.getIdeal().getData(currentAdaline) - output.getData(currentAdaline);
