...
public class SmartLearningRate implements Strategy {
	...
	public void init(final MLTrain train) {
		...
		EncogLogging.log(EncogLogging.LEVEL_DEBUG, "Starting learning rate: " + this.currentLearningRate);
	...
	public void postIteration() {
		if (this.ready) {
			if (this.train.getError() > this.lastError) {
				...
				this.setter.setLearningRate(this.currentLearningRate);
				EncogLogging.log(EncogLogging.LEVEL_DEBUG, "Adjusting learning rate to {}" + this.currentLearningRate);
			}
		} else {
			this.ready = true;
		}
