...
public class SmartMomentum implements Strategy {
	...
	public void postIteration() {
		if (this.ready) {
			...
			if ((this.lastImprovement > 0) || (Math.abs(this.lastImprovement) < SmartMomentum.MIN_IMPROVEMENT)) {
				this.lastMomentum++;
				...
				if (this.lastMomentum > SmartMomentum.MOMENTUM_CYCLES) {
					...
					EncogLogging.log(EncogLogging.LEVEL_DEBUG, "Adjusting momentum: " + this.currentMomentum);
				}
			} else {
