...
public class ADALINEPattern implements NeuralNetworkPattern {
	...
	public MLMethod generate() {
		...
		final Layer inputLayer = new BasicLayer(new ActivationLinear(), true, this.inputNeurons);
		final Layer outputLayer = new BasicLayer(new ActivationLinear(), false, this.outputNeurons);
