...
public class EncogFileSection {
	 ...
	 *            The params.
	 * @param name
	 *            The name of the param to parse.
	 * @return The parsed activation function.
	 */
	public static ActivationFunction parseActivationFunction(final Map<String, String> params, final String name) {
		String value = null;
		try {
	 ...
	 */
	public static boolean parseBoolean(final Map<String, String> params, final String name) {
		String value = null;
		try {
			value = params.get(name);
			if (value == null) {
	 ...
	 */
	public static double parseDouble(final Map<String, String> params, final String name) {
		String value = null;
		try {
			value = params.get(name);
			if (value == null) {
	 ...
	 */
	public double[] parseDoubleArray(final Map<String, String> params, final String name) {
		String value = null;
		try {
			value = params.get(name);
			if (value == null) {
	 ...
	 */
	public static int parseInt(final Map<String, String> params, final String name) {
		String value = null;
		try {
			value = params.get(name);
			if (value == null) {
	 ...
	 */
	public static int[] parseIntArray(final Map<String, String> params, final String name) {
		String value = null;
		try {
			value = params.get(name);
			if (value == null) {
	 ...
	 */
	public static Matrix parseMatrix(final Map<String, String> params, final String name) {
	 ...
	 *            The section name.
	 * @param theSubSectionName
	 *            The sub section name.
	 */
	public EncogFileSection(final String theSectionName, final String theSubSectionName) {
		super();
