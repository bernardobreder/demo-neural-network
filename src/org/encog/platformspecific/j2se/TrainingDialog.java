...
public class TrainingDialog extends JDialog implements ActionListener {
	 ...
	 */
	public static void trainDialog(final MLTrain train, final BasicNetwork network, final MLDataSet trainingSet) {
	 ...
	 *            The training set to use.
	 */
	public static void trainDialog(final BasicNetwork network, final MLDataSet trainingSet) {
