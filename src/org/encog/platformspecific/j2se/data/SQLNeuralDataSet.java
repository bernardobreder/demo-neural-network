...
public class SQLNeuralDataSet extends BasicMLDataSet {
	 ...
	 */
	public SQLNeuralDataSet(final Connection theConnection, final String theSQL, final int theInputSize,
	 ...
	 */
	public SQLNeuralDataSet(final String sql, final int inputSize, final int idealSize, final String driver,
