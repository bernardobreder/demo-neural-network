...
public interface EncogPluginService1 extends EncogPluginBase {
	 ...
	 */
	MLMethod createMethod(final String methodType, final String architecture, final int input, final int output);
	 ...
	 *            The training data.
	 * @param type
	 *            Type type of trainer.
	 * @param args
	 *            The training args.
	 * @return The new training method.
	 */
	MLTrain createTraining(final MLMethod method, final MLDataSet training, final String type, final String args);
