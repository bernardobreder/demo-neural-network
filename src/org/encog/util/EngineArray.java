...
public final class EngineArray {
	 ...
	 *            The length.
	 */
	public static void arrayCopy(final double[] source, final int sourcePos, final double[] target, final int targetPos,
			final int length) {
	 ...
	 */
	public static int findStringInArray(final String[] search, final String searchFor) {
	...
	public static void arrayCopy(final byte[] source, final int sourcePos, final byte[] target, final int targetPos,
			final int length) {
		System.arraycopy(source, sourcePos, target, targetPos, length);
