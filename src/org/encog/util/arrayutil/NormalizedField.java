...
public class NormalizedField implements Serializable {
	 ...
	 *            The normalized low.
	 */
	public NormalizedField(final double theNormalizedHigh, final double theNormalizedLow) {
	 ...
	 *            The name of this column.
	 */
	public NormalizedField(final NormalizationAction theAction, final String theName) {
	 ...
	 *            The normalized low.
	 */
	public NormalizedField(final NormalizationAction theAction, final String theName, final double ahigh,
	 ...
	 * @param high
	 *            The high end of the range for the field.
	 * @param low
	 *            The low end of the range for the field.
	 */
	public NormalizedField(final String theName, final NormalizationAction theAction, final double high,
			final double low) {
		this.name = theName;
		this.action = theAction;
	...
	public final ClassItem determineClass(final double[] data) {
		...
		case SingleField:
			...
			break;
		default:
			throw new QuantError("Unknown action: " + this.action);
		}
	 ...
	 *            The action to take.
	 * @param classFrom
	 *            The beginning class item.
	 * @param classTo
	 *            The ending class item.
	 * @param high
	 *            The output high value.
	 * @param low
	 *            The output low value.
	 */
	public final void makeClass(final NormalizationAction theAction, final int classFrom, final int classTo,
			final int high, final int low) {

		if ((theAction != NormalizationAction.Equilateral) && (theAction != NormalizationAction.OneOf)
	 ...
	 *            The output low value.
	 */
	public final void makeClass(final NormalizationAction theAction, final String[] cls, final double high,
			final double low) {
		if ((theAction != NormalizationAction.Equilateral) && (theAction != NormalizationAction.OneOf)
				&& (theAction != NormalizationAction.SingleField)) {
			throw new QuantError("Unsupported normalization type");
