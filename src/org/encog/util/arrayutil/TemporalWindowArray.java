...
public class TemporalWindowArray {
	 ...
	 */
	public TemporalWindowArray(final int theInputWindow, final int thePredictWindow) {
	...
	public MLDataPair processToPair(double[] data) {
		...
		for (int i = 0; i < stopPoint; i++) {
			MLData inputData = new BasicMLData(this.inputWindow);
			MLData idealData = new BasicMLData(this.predictWindow);
