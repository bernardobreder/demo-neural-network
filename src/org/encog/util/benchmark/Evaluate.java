...
public final class Evaluate {
	...
	public static int evaluateTrain(int input, int hidden1, int hidden2, int output) {
		final BasicNetwork network = EncogUtility.simpleFeedForward(input, hidden1, hidden2, output, true);
		final MLDataSet training = RandomTrainingFactory.generate(1000, 10000, input, output, -1, 1);
	 ...
	 */
	public static int evaluateTrain(final BasicNetwork network, final MLDataSet training) {
