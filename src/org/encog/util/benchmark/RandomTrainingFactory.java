...
/**
 * Class used to generate random training sets. This will always generate the
 * same number outputs, as it always uses the same seed values. This allows for
 * the consistent results needed by the benchmark.
 */
public final class RandomTrainingFactory {
	 ...
	 */
	public static BasicMLDataSet generate(final long seed, final int count, final int inputCount, final int idealCount,
		...
		for (int i = 0; i < count; i++) {
			...
			final BasicMLDataPair pair = new BasicMLDataPair(inputData, idealData);
			result.add(pair);
	 ...
	 *
	 * @param training
	 *            The training set to generate into.
	 * @param seed
	 *            The seed to use.
	 * @param count
	 *            How much data to generate.
	 * @param min
	 *            The low random value.
	 * @param max
	 *            The high random value.
	 */
	public static void generate(final MLDataSet training, final long seed, final int count, final double min,
			final double max) {
