...
public final class URLUtility {
	 ...
	 */
	public static URL constructURL(final URL base, final String url, final boolean stripRef) throws IOException {
	 ...
	 */
	public static String convertFilename(final String base, final URL url, final boolean mkdir) {
