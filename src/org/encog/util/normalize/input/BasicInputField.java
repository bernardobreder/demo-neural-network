...
/**
 * Provides basic functionality, such as min/max and current value for other
 * input fields.
 */
public class BasicInputField implements InputField {
	...
	/**
	 * True if this field is used to actually generate the input for the neural
	 * network.
	 */
	...
	/**
	 * @return The current value of the input field. This is only valid, while
	 *         the normalization is being performed.
	 */
	@Override
	...
	/**
	 * @return True, if this field is used for network input. This is needed so
	 *         that the buildForNetworkInput method of the normalization class
	 *         knows how many input fields to expect. For instance, fields used
	 *         only to segregate data are not used for the actual network input
	 *         and may not be provided when the network is actually being
	 *         queried.
	 */
	@Override
	...
	/**
	 * Set the current value of this field. This value is only valid while the
	 * normalization is occurring.
	 *
	 * @param currentValue
	 ...
	 *
	 * @param max
	 *            The maximum value encountered on this field so far.
	 */
	@Override
