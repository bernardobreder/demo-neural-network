...
public class InputFieldCSVText extends InputFieldCSV {
	...
	/**
	 * Construct an InputFieldCSVText with the default constructor. This is
	 * mainly used for reflection.
	 */
	 ...
	 */
	public InputFieldCSVText(final boolean usedForNetworkInput, final File file, final int offset) {
	...
	public int addMapping(String name) {
		this.mappings.put(name, this.currentMapIndex);
		int result = this.currentMapIndex;
