...
public class InputFieldMLDataSet extends BasicInputField {
	...
	/**
	 * The input or ideal index. This treats the input and ideal as one long
	 ...
	 *            Is this field used for neural input.
	 * @param data
	 *            The data set to use.
	 * @param offset
	 *            The input or ideal index to use. This treats the input and
	 *            ideal as one long array, concatenated together.
	 */
	public InputFieldMLDataSet(final boolean usedForNetworkInput, final NeuralDataSet data, final int offset) {
		this.data = data;
		this.offset = offset;
	...
	/**
	 * @return The field to be accessed. This treats the input and ideal as one
