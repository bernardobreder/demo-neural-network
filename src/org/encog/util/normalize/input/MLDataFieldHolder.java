...
/**
 * Simple holder class used internally for Encog. Used as a holder for a:
 *
 * NeuralDataPair Iterator InputFieldNeuralDataSet
 */
public class MLDataFieldHolder implements Serializable {
	 ...
	 *            A field.
	 */
	public MLDataFieldHolder(final Iterator<MLDataPair> iterator, final InputFieldMLDataSet field) {
		super();
