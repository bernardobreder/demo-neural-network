...
/**
 * Provides very basic functionality for output fields. Primarily provides the
 * ideal instance variable.
 */
public abstract class BasicOutputField implements OutputField {
	...
	/**
	 * @return Is this field part of the ideal data uses to train the neural
	 *         network.
	 */
	@Override
	 ...
	 *
	 * @param ideal
	 *            Is this field part of the ideal data uses to train the neural
	 *            network.
	 */
	@Override
