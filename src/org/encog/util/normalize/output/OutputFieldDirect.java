...
public class OutputFieldDirect extends BasicOutputField {
	 ...
	 *
	 * @param sourceField
	 *            The source field to pass directly on.
	 */
	...
	/**
	 * Calculate the value for this field. This will simply be the value from
	 * the input field.
	 *
	 * @param subfield
	 *            Not used, as this output field type does not support
	 *            subfields.
