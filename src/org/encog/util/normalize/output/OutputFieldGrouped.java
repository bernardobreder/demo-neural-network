...
/**
 * Defines an output field that can be grouped. Groupable classes will extend
 * this class.
 *
 */
public abstract class OutputFieldGrouped extends BasicOutputField {
	...
	/**
	 * The source field, this is the input field that provides data for this
	 * output field.
	 */
	 ...
	 */
	public OutputFieldGrouped(final OutputFieldGroup group, final InputField sourceField) {
		this.group = group;
