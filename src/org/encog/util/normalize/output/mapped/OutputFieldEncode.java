...
/**
 * An encoded output field. This allows ranges of output values to be mapped to
 * specific values.
 */
public class OutputFieldEncode extends BasicOutputField {
	 ...
	 *
	 * @param sourceField
	 *            The field that this is based on.
	 */
	 ...
	 * @param value
	 *            The value that the field should produce for this range.
	 */
	 ...
	 *
	 * @param catchAll
	 *            The catch all value that is to be returned if none of the
	 *            ranges match.
	 */
