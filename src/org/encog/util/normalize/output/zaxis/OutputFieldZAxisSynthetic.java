...
/**
 * This field represents the synthetic value used in Z-Axis normalization. For
...
public class OutputFieldZAxisSynthetic extends OutputFieldGrouped {
	...
	public double calculate(final int subfield) {
		final double l = ((ZAxisGroup) this.getGroup()).getLength();
		final double f = ((ZAxisGroup) this.getGroup()).getMultiplier();
		final double n = this.getGroup().getGroupedFields().size();
