 ...
 * Everything that is between these two indexes will be used. The sample repeats
 * over and over. For example, if you choose a sample size of 10, and a
 * beginning index of 0 and an ending index of 5, you would get half of the
 * first 10 element, then half of the next ten, and so on.
 *
 */
public class IndexSampleSegregator extends IndexSegregator {
	 ...
	 *            The sample size.
	 */
	public IndexSampleSegregator(final int startingIndex, final int endingIndex, final int sampleSize) {
	...
	public boolean shouldInclude() {
		final int sampleIndex = this.getCurrentIndex() % this.sampleSize;
		this.rollIndex();
