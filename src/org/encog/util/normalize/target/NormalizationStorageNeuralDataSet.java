...
public class NormalizationStorageNeuralDataSet implements NormalizationStorage {
	 ...
	 *            The output count.
	 */
	public NormalizationStorageNeuralDataSet(final int inputCount, final int idealCount) {
	...
	public void write(final double[] data, final int inputCount) {
		...
		if (this.idealCount == 0) {
			...
			final BasicNeuralData inputData = new BasicNeuralData(this.inputCount);
			final BasicNeuralData idealData = new BasicNeuralData(this.idealCount);
