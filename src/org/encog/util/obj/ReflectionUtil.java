...
public final class ReflectionUtil {
	 ...
	 */
	public static void getAllFields(final Class<?> c, final Collection<Field> fields) {
	 ...
	 */
	public static boolean isInstanceOf(final Class<?> class1, final Class<?> class2) {
	...
	public static boolean isPrimitive(final Object obj) {
		return (obj instanceof Character) || (obj instanceof Integer) || (obj instanceof Short)
	 ...
	 *
	 * @param <T>
	 *            The type of object to generate for.
	 * @param o
