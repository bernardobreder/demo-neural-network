...
public final class SerializeObject {
	 ...
	 */
	public static Serializable load(final File filename) throws IOException, ClassNotFoundException {
		Serializable object;
	 ...
	 *             An IO error occurred.
	 */
	public static void save(final File filename, final Serializable object) throws IOException {
