...
public class TimeSpan {
	...
	private long getSpanCenturies() {
		return this.getSpanYears() / TimeSpan.YEARS_CENTURY;
	}
	...
	private long getSpanDays() {
		return this.getSpanHours() / TimeSpan.HOURS_DAY;
	}
	...
	private long getSpanHours() {
		return this.getSpanMinutes() / TimeSpan.MINUTES_HOUR;
	}
	...
	private long getSpanMillennia() {
		return this.getSpanYears() / TimeSpan.YEARS_MIL;
	}
	...
	private long getSpanMinutes() {
		return this.getSpanSeconds() / TimeSpan.SECONDS_MINUTE;
	}
	...
	private long getSpanMonths() {
		...
		return endCal.get(Calendar.MONTH) - startCal.get(Calendar.MONTH)
				+ (endCal.get(Calendar.YEAR) - startCal.get(Calendar.YEAR)) * TimeSpan.MONTHS_YEAR;
	}
	...
	private long getSpanScores() {
		return this.getSpanYears() / TimeSpan.YEARS_SCORE;
	}
	...
	private long getSpanSeconds() {
		...
		return (toCalendar.getTimeInMillis() - fromCalendar.getTimeInMillis()) / TimeSpan.YEARS_MIL;
	...
	private long getSpanWeeks() {
		return this.getSpanDays() / TimeSpan.DAYS_WEEK;
	}
	...
	private long getSpanYears() {
		return this.getSpanMonths() / TimeSpan.MONTHS_YEAR;
	}
