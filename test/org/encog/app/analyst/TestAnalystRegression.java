...
public class TestAnalystRegression extends TestCase {
	...
	public void testClassification() throws Exception {
		File rawFile = this.TEMP_DIR.createFile("simple.csv");
		File egaFile = this.TEMP_DIR.createFile("simple.ega");
		File outputFile = this.TEMP_DIR.createFile("simple_output.csv");
