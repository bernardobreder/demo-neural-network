...
public class TestFoldedDataSet extends TestCase {
	...
	private FoldedDataSet performFoldTest(int recordCount, int foldCount, int testIndex1, int testCount1,
			int testIndex2, int testCount2) {
		...
		this.testFoldedAccess(dataSet, foldedData);
	...
	public void testFoldedEven() {
		this.performFoldTest(50, 5, 0, 10, 4, 10);
	}

	@Test
	public void testFoldedOdd() {
		this.performFoldTest(53, 5, 0, 10, 4, 13);
	}

	@Test
	public void testFoldedSmall() {
		this.performFoldTest(3, 5, 0, 1, 2, 1);
	}
}
