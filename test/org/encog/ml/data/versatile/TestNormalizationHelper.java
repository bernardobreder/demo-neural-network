...
public class TestNormalizationHelper {
	...
	public void testColumnsSerial() throws ClassNotFoundException, IOException {
		...
		List<ColumnDefinition> inputColumns = new ArrayList<>();
		List<ColumnDefinition> outputColumns = new ArrayList<>();
	 ...
	 *
	 * @param a
	 *            Null or a {@link NormalizationHelper}.
	 * @param b
	 *            Null or a {@link NormalizationHelper}.
	 */
	private void smokeTestEqual(NormalizationHelper a, NormalizationHelper b) {
		if (a != b) {
			// Incomplete test of equality.
			Assert.assertFalse((a == null) || (b == null)); // Not equal if
															// exactly one is
															// null.
