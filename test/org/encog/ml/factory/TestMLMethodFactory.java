...
public class TestMLMethodFactory extends TestCase {
	...
	public void testFactoryFeedforwardError() {
		...
		this.expectError(MLMethodFactory.TYPE_FEEDFORWARD, ARC1);
		this.expectError(MLMethodFactory.TYPE_FEEDFORWARD, ARC2);
		this.expectError(MLMethodFactory.TYPE_FEEDFORWARD, ARC3);
