...
public class TestSearch extends TestCase {
	...
	public void testDepthFirstSearch() {
		...
		Assert.assertEquals(3, this.countIterations(search));
	...
	public void testBredthFirstSearch() {
		...
		Assert.assertEquals(4, this.countIterations(search));
	...
	public void testAStar() {
		...
		AStarSearch search = new AStarSearch(graph, nodeA, new SimpleDestinationGoal(nodeD),
