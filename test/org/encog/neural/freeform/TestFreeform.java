...
public class TestFreeform extends TestCase {
	...
	public void testCreation() {
		...
		Assert.assertEquals(basicNetwork.getInputCount(), freeformNetwork.getInputCount());
		Assert.assertEquals(basicNetwork.getOutputCount(), freeformNetwork.getOutputCount());
		Assert.assertEquals(basicNetwork.encodedArrayLength(), freeformNetwork.encodedArrayLength());
	}
	...
	public void testEncode() {
		...
		Assert.assertEquals(trainedNetwork.calculateError(trainingData), trainedNetwork.calculateError(trainingData),
				0.01);
	}
}
