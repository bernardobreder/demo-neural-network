...
public class TestPersistART extends TestCase {
	...
	public void testPersistEG() {
		ART1 network = this.create();

		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, network);
		ART1 network2 = (ART1) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		ART1 network2 = (ART1) SerializeObject.load(this.SERIAL_FILENAME);
