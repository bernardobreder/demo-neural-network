...
public class TestPersistBAM extends TestCase {
	...
	public void testPersistEG() {
		BAM network = this.create();

		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, network);
		BAM network2 = (BAM) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);

		this.validateBAM(network2);
	}
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		BAM network2 = (BAM) SerializeObject.load(this.SERIAL_FILENAME);
