...
public class TestPersistBasicNetwork extends TestCase {
	...
	public void testPersistEG() {
		BasicNetwork network = this.create();

		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, network);
		BasicNetwork network2 = (BasicNetwork) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		BasicNetwork network2 = (BasicNetwork) SerializeObject.load(this.SERIAL_FILENAME);
