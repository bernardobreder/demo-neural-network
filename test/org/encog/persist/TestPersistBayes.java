...
public class TestPersistBayes extends TestCase {
	...
	public void testPersistEG() {
		BayesianNetwork network = this.create();

		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, network);
		BayesianNetwork network2 = (BayesianNetwork) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		BayesianNetwork network2 = (BayesianNetwork) SerializeObject.load(this.SERIAL_FILENAME);
