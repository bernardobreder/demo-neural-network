...
public class TestPersistBoltzmann extends TestCase {
	...
	public void testPersistEG() {
		...
		BoltzmannMachine network2 = (BoltzmannMachine) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);

		this.validateHopfield(network2);
	}
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		BoltzmannMachine network2 = (BoltzmannMachine) SerializeObject.load(this.SERIAL_FILENAME);
