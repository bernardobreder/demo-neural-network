...
public class TestPersistEPLPopulation {
	...
	public void testPersistEG() {
		PrgPopulation pop = this.create();
		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, pop);
		PrgPopulation pop2 = (PrgPopulation) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);
		this.validate(pop2);
	}
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		PrgPopulation pop2 = (PrgPopulation) SerializeObject.load(this.SERIAL_FILENAME);
		this.validate(pop2);
	}
