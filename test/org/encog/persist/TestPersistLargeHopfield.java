...
public class TestPersistLargeHopfield extends TestCase {
	...
	public void testPersistEG() {
		...
		HopfieldNetwork network2 = (HopfieldNetwork) EncogDirectoryPersistence.loadObject((this.EG_FILENAME));
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		HopfieldNetwork network2 = (HopfieldNetwork) SerializeObject.load(this.SERIAL_FILENAME);
