...
public class TestPersistSOM extends TestCase {
	...
	public void testPersistEG() {
		SOM network = this.create();

		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, network);
		SOM network2 = (SOM) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		SOM network2 = (SOM) SerializeObject.load(this.SERIAL_FILENAME);
