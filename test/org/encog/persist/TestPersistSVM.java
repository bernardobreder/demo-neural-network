...
public class TestPersistSVM extends TestCase {
	...
	public void testPersistEG() {
		SVM network = this.create();

		EncogDirectoryPersistence.saveObject((this.EG_FILENAME), network);
		SVM network2 = (SVM) EncogDirectoryPersistence.loadObject((this.EG_FILENAME));
	...
	public void testPersistSerial() throws IOException, ClassNotFoundException {
		...
		SVM network2 = (SVM) SerializeObject.load(this.SERIAL_FILENAME);
