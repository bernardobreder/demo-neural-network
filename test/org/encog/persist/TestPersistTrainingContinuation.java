...
public class TestPersistTrainingContinuation extends TestCase {
	...
	public void testRPROPContPersistEG() {
		...
		EncogDirectoryPersistence.saveObject(this.EG_FILENAME, cont);
		TrainingContinuation cont2 = (TrainingContinuation) EncogDirectoryPersistence.loadObject(this.EG_FILENAME);
