...
public class TestMultiplicative extends TestCase {
	...
	public DataNormalization create(double[][] arrayOutput) {
		...
		norm.addInputField(a = new InputFieldArray2D(false, this.SAMPLE1, 0));
		norm.addInputField(b = new InputFieldArray2D(false, this.SAMPLE1, 1));
		norm.addInputField(c = new InputFieldArray2D(false, this.SAMPLE1, 2));
	...
	public void testAbsolute() {
		...
		DataNormalization norm = this.create(arrayOutput);
		norm.process();
